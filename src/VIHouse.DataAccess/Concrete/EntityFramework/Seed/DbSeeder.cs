...
public static class DbSeeder
{
    ...
    private static async Task SeedApplicationsAsync(VIHouseDbContext db)
    {
        ...
        db.Applications.Add(new Application
        {
            ...
            Country = "TR",
            City = "Istanbul",
            JobTitle = "Founder & CEO, Aydin Ventures",
            EarningsBand = "1-3m",
            AboutStatement = "A payments infrastructure platform for SME lending across the Middle East.",
            ExpectationsStatement = "Looking to connect with other founders scaling past their first big raise.",
        ...
        db.Applications.Add(new Application
        {
            ...
            Country = "GB",
            City = "London",
            JobTitle = "Managing Partner, Webb & Co",
            EarningsBand = "6m+",
            AboutStatement = "An early-stage fund focused on operator-led fintech and infrastructure.",
            ExpectationsStatement = "Want direct access to the founders VI House curates before they raise.",
        ...
        db.Applications.Add(new Application
        {
            ...
            Country = "US",
            City = "New York",
            JobTitle = "Co-Founder, Northline",
            EarningsBand = "3-6m",
            AboutStatement = "A DTC logistics platform doing low-eight-figures ARR.",
            ExpectationsStatement = "Ready to plug into a room of operators who've actually scaled past 7 figures.",
